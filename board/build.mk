...
flash: obj/$(PROJ_NAME).bin
	PYTHONPATH=../ python3 -c "from panda import Panda; Panda().flash('obj/$(PROJ_NAME).bin')"
...
recover: obj/bootstub.$(PROJ_NAME).bin obj/$(PROJ_NAME).bin
	-PYTHONPATH=../ python3 -c "from panda import Panda; Panda().reset(enter_bootstub=True); Panda().reset(enter_bootloader=True)"
	sleep 1.0
